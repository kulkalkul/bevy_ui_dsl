...
pub fn c_root(_d: &AssetServer, b: &mut NodeBundle) {
    b.style.width = Val::Percent(100.);
    b.style.height = Val::Percent(100.)
}

pub fn c_half(_d: &AssetServer, b: &mut NodeBundle) {
    let s = &mut b.style;
...
pub fn c_green(_d: &AssetServer, b: &mut NodeBundle) {
    b.background_color = Color::rgb_u8(125, 212, 148).into();
}

pub fn c_blue(_d: &AssetServer, b: &mut NodeBundle) {
    b.background_color = Color::rgb_u8(125, 164, 212).into();
}

pub fn c_text(_d: &AssetServer, b: &mut TextBundle) {
...
pub fn c_grid(_d: &AssetServer, b: &mut NodeBundle) {
